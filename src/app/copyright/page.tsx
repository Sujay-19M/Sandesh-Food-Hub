  ...
  return (
    <Container className="py-12">
      ...
      <div className="prose prose-lg max-w-3xl mx-auto text-foreground/80">
        ...
        <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Trademarks</h2>
        <p>
        ...
        <p className="mt-8">This is sample copyright information. Please consult with a legal professional to ensure it meets your specific requirements.</p>
      </div>
    </Container>
  );
}
